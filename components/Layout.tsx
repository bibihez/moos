...
export const Layout: React.FC<LayoutProps> = ({ children, title, hideLogo = false }) => {
  return (
    <div className="min-h-[100dvh] flex flex-col items-center pt-[max(2rem,env(safe-area-inset-top))] pb-[max(3rem,env(safe-area-inset-bottom))] px-4 relative overflow-hidden">
